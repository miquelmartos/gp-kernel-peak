...
#include "board-cellon-C8680-sensor.h"
...
#ifdef CONFIG_ENABLE_CELLON_C8680_WLAN
...
static struct platform_device msm_device_adspdec = {
	.name = "msm_adspdec",
	.id = -1,
	.dev = { .platform_data = &msm_device_adspdec_database },
};
...
struct platform_device oemrapitest_device = {
	.name   = "oemrapitest",
	.id     = 0,
};
...
static struct msm_psy_batt_pdata msm_psy_batt_data = {
	...
	.voltage_max_design     = 4360,//arvin--modify
...
static void __init msm7x27a_reserve(void)
{
	...
	msm_reserve();
#ifdef CONFIG_ANDROID_RAM_CONSOLE
	ram_console_resources[0].start = msm7x27a_reserve_table[MEMTYPE_EBI1].start - SZ_256K;
	ram_console_resources[0].end = ram_console_resources[0].start + SZ_256K - 1;
#endif
}
...
{
	platform_device_register(&oemrapitest_device);
}
...
static void __init msm7x2x_init(void)
{
...
#ifdef CONFIG_ENABLE_CELLON_C8680_SENSORS
	msm7627a_sensor_init();
#endif
#ifdef CONFIG_ENABLE_CELLON_C8680_BT
	msm7627a_bt_power_init();
#endif
#ifdef CONFIG_ENABLE_CELLON_C8680_CAMERA
	...
	cellon_oem_rpc(); //gsh add
#ifdef CONFIG_CPU_FREQ_GOV_ONDEMAND_2_PHASE
set_two_phase_freq(1152000);
#endif
#ifdef CONFIG_CPU_FREQ_GOV_INTELLIDEMAND
id_set_two_phase_freq(1152000);
#endif
}
